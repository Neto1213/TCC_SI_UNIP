...
def get_plan_from_gpt(
    ...
    concisao = (
        "RestriÃ§Ãµes de concisÃ£o: por semana, no MÃXIMO 3 tÃ³picos, 3 tarefas e 3 referÃªncias; "
        "cada string com até 120 caracteres. Se estiver perto do limite de tokens, "
        "priorize completar o JSON reduzindo conteÃºdo, nunca deixe chaves sem fechar."
    )
    ...
    user_prompt = (
        ...
        f"{concisao}\n"
        f"Use o esqueleto a seguir como contexto e gere {semanas} semanas.\n"
